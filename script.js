...
/* ==========================================
   5. DOM ELEMENT BINDINGS & LISTENERS
   ========================================== */
...
function initDomElements() {
  ...
  qPaper = document.getElementById('q-paper');
  ...
  marksButtons = document.querySelectorAll('.marks-btn');
  ...
  modeYearRadio = document.getElementById('mode-year');
  modeTopicRadio = document.getElementById('mode-topic');
