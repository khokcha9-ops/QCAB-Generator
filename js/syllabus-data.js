...
const SYLLABUS_HTML = `
    <div class="syllabus-card prelims-card">
        ...
        <ul>
            ...
            <li><strong>Paper II - (200 marks) Duration: Two hours</strong>
                <ul>
                    <li>Comprehension</li>
    ...
    <div class="syllabus-card anthro1-card">
        ...
        <ul>
            ...
            <li>1.3 Main branches of Anthropology, their scope and relevance:
                <ul>
            ...
            <li>1.4 Human Evolution and emergence of Man:
                <ul>
            ...
            <li>1.6 Phylogenetic status, characteristics and geographical distribution of the following:
                <ul>
